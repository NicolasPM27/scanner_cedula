  ...
  template: `
    ...
    <ion-content [fullscreen]="true" class="verificacion-content">
      <div class="verificacion-container">
        ...
        <!-- Estado: Usuario no encontrado (nuevo) -->
        @if (estadoVerificacion() === 'no_encontrado') {
          <div class="result-section animate-slide-up">
            <div class="result-icon new-user">
              <ion-icon name="person-circle"></ion-icon>
            </div>
            <h2 class="headline-medium">Nuevo registro</h2>
            <p class="body-large text-muted">No encontramos registros previos. Continuemos con la actualización de sus datos.</p>
            ...
            <ion-button expand="block" size="large" (click)="continuar()">
